...
function SeminarCard({ seminar, onDelete }) {
    ...
    return (
        <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow border border-gray-100 flex flex-col">
            {/* Card header */}
            <div className="bg-gradient-to-r from-orange-600 to-orange-500 rounded-t-lg px-5 py-4 text-white">
                ...
                {seminar.productSector && (
                    <p className="text-orange-100 text-xs mt-1 font-medium">{seminar.productSector}</p>
                )}
            </div>

            {/* Card body */}
            <div className="px-5 py-4 flex-1 space-y-2 text-sm text-gray-600">
                {seminar.cityVenue && (
                ...
                {seminar.proposedBudget != null && (
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-medium text-gray-800">PKR {Number(seminar.proposedBudget).toLocaleString('en-PK')}</span>
                    </div>
                )}
            ...
            <div className="px-5 py-3 border-t border-gray-100 flex gap-2">
                <Link
                    ...
                    className="flex-1 text-center text-sm font-medium text-orange-700 hover:text-orange-900 transition-colors"
                >
                    View Details
                </Link>
                <Link
                ...
                <button
                    ...
                    className="flex-1 text-center text-sm font-medium text-red-500 hover:text-red-700 transition-colors"
                >
                    Delete
                </button>
            </div>
            ...
            <main className="container mx-auto px-4 py-8">
                ...
                <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <button
                        ...
                        className="self-start px-6 py-2 bg-orange-600 text-white rounded-md hover:bg-orange-700 transition-colors font-medium"
                    >
                        + Add Seminar
                    </button>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 mb-6">
                    {[
                        { label: 'Planned', key: 'PLANNED', color: 'text-blue-700', bg: 'bg-blue-50' },
                        { label: 'Completed', key: 'COMPLETED', color: 'text-green-700', bg: 'bg-green-50' },
                        { label: 'Cancelled', key: 'CANCELLED', color: 'text-red-700', bg: 'bg-red-50' },
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6 flex flex-wrap gap-4 items-center">
                    ...
                    <span className="ml-auto text-sm text-gray-500">
                        Showing <span className="font-semibold text-gray-700">{seminars.length}</span> seminar{seminars.length !== 1 ? 's' : ''}
                    </span>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="bg-white rounded-lg shadow-md p-12 text-center">
                        ...
                        <p className="text-gray-600 text-lg font-medium">No seminars found.</p>
            ...
            {deleteTarget && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 px-4">
                    <div className="bg-white rounded-lg shadow-xl p-6 max-w-md w-full">
                        <h3 className="text-lg font-bold text-gray-900 mb-2">Delete Seminar</h3>
                        <p className="text-gray-600 mb-6">
                            Are you sure you want to delete{' '}
                            <span className="font-semibold">&ldquo;{deleteTarget.title}&rdquo;</span>? This action cannot be undone.
                        </p>
